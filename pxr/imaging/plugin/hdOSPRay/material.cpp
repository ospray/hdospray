...
TF_DEFINE_PRIVATE_TOKENS(HdOSPRayMaterialTokens,
                         (UsdPreviewSurface)(HwPtexTexture_1));

TF_DEFINE_PRIVATE_TOKENS(
    HdOSPRayTokens,
    (UsdPreviewSurface)(diffuseColor)(specularColor)(emissiveColor)(metallic)(
        roughness)(clearcoat)(clearcoatRoughness)(ior)(color)(opacity)(
        UsdUVTexture)(normal)(displacement)(file)(filename)(scale)(wrapS)(
        wrapT)(repeat)(mirror)(HwPtexTexture_1)(faceOffset)(ptexFaceOffset));
...
HdOSPRayMaterial::HdOSPRayMaterial(SdfPath const &id) : HdMaterial(id) {
...
void HdOSPRayMaterial::_ProcessTextureNode(HdMaterialNode node,
                                           TfToken textureName) {
  ...
  TF_FOR_ALL(param, node.parameters) {
    ...
    } else if (name == HdOSPRayTokens->faceOffset ||
               name == HdOSPRayTokens->ptexFaceOffset) {
...
OSPMaterial HdOSPRayMaterial::CreateDefaultMaterial(GfVec4f color) {
  std::string rendererType =
      HdOSPRayConfig::GetInstance().usePathTracing ? "pathtracer" : "scivis";
  ...
  if (rendererType == "pathtracer") {
    ...
    // Carson: apparently colors are actually stored as a single color value for
    // entire object
