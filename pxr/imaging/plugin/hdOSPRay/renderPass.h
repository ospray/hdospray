...
private:
    ...
    std::vector<rkcommon::math::vec4f> _colorBuffer;
    ...
    std::vector<rkcommon::math::vec3f> _normalBuffer;
    std::vector<rkcommon::math::vec3f> _albedoBuffer;
    std::vector<rkcommon::math::vec4f> _denoisedBuffer;
